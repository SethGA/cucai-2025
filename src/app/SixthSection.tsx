...
export function SixthSection() {
  return (
    ...
    <main 
      className={`${IBMPlexSans.className} h-[350px] w-[100dvw] overflow-x-hidden overflow-y-scroll flex flex-col items-center z-10 no-scrollbar font-light text-white pb-32`}
